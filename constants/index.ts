...
export const FOOTER_LINKS = [
  {
    title: "Learn More",
    links: ["About", "Jobs", "Privacy Policy", "Contact US"],
  },
  { title: "Our comunity", links: ["BookHUb", "Story-Club"] },
];
...
export const FICTION_CATEGORIES = [
  ...
  { label: "New York Times Best Sellers", value: "new-york-times-bestsellers" },
  { label: "Popular Fiction", value: "popular-fiction" },
...
export const TEENS_YOUNG_ADULT_CATEGORIES = [
  ...
  { label: "New York Times Best Sellers", value: "new-york-times-bestsellers" },
  { label: "Popular Teens & Young Adult", value: "popular-teens-young-adult" },
  { label: "Action and Adventure", value: "action-and-adventure" },
